...
<body>
    ...
    <!-- ========== header start ========== -->
    <header class="header pt-2 pb-2" style="height: 80px">
                ...
                <div class="col-lg-7 col-md-7 col-6">
                    <div class="header-right">
                        ...
                        <div class="profile-box ml-15">
                            <button class="dropdown-toggle p-2 border-0" type="button" id="profile"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="profile-info">
                                    <div class="info">
                                        <h6 class="text-dark">{{ Auth::user()->name }}  <i class="lni lni-lock-alt"
                                                style="font-size: 20px; font-weight: 600"></i></h6>
                                    </div>
                                </div>
